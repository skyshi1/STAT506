...
plot_pvalue_distributions <- function(results_df) {
  ggplot(results_df, aes(x = PValue, y = ..density..)) +
    geom_histogram(binwidth = 0.05, color = "black", fill = "skyblue", alpha = 0.7) +
    facet_grid(SampleSize ~ Distribution, scales = "free_y") +
    labs(
      title = "P-Value Distributions Across Distributions and Sample Sizes",
      x = "P-Value",
      y = "Density"
    ) +
    theme_minimal() +
